...
with open('face_recognition_research_2025.md', 'w') as f:
    f.write(research_summary)

print("Created comprehensive research summary")
print(f"Research covers {research_summary.count('face-api')} mentions of face-api.js")
print(f"Research covers {research_summary.count('MediaPipe')} mentions of MediaPipe")
print(f"Total research document size: {len(research_summary)} characters")