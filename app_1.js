class FaceRecognitionApp {
    ...
    setupEventListeners() {
        ...
        document.getElementById('recognize-btn').addEventListener('click', () => this.recognizeFace());
    }
        ...
        if (this.registeredFaces.length === 0) {
            facesList.innerHTML = `
                <div class="empty-state">
                    <p>No faces registered yet. Upload an image above to get started.</p>
                </div>
            `;
            return;
        }
